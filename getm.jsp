...
String sql ="select market.market_id,market_name,pincode,city,area from Market,farmer_market where Market.market_id= Farmer_Market.market_id  and Farmer_Market.user_id=? order by market_id";
